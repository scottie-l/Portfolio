  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/codefellows/cra-template-react-portfolio" target="https://github.com/scottie-l" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
